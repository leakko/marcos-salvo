...
export default function AboutMe() {
  return (
    <section id="about" className={cn('w-screen flex flex-col justify-center md:items-center bg-primary-500 text-left py-16 px-8')}>
      <div className={cn('max-w-5xl mx-auto md:px-0')}>
