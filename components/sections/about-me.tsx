...
export default function AboutMe() {
  return (
    <section id="about" className={cn('flex flex-col  min-h-[calc(100vh-100px)] justify-center bg-primary-500 text-left px-8 py-10')}>
      <div className={cn('max-w-4xl mx-auto w-screen')}>
